...
type RegisterErrorProps = Readonly<{
...
export default function RegisterError({ error, reset }: RegisterErrorProps) {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-12rem)] w-full max-w-[var(--store-container)] items-center px-[var(--store-page-gutter)] py-10 lg:py-16">
      <section
        className="w-full rounded-ui border border-border bg-surface p-6 shadow-card sm:p-8"
        role="alert"
      >
        ...
        <h1 className="mt-2 font-display text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">
          We couldn&apos;t open registration
        </h1>
        <p className="mt-3 max-w-2xl leading-7 text-muted">
          Something interrupted the account creation page. Try loading it again,
          or continue browsing and create your account later.
        </p>
